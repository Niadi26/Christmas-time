...
garage.garage.addEventListener('click', async (e) => {
  ...
  if (elementClick.dataset.action === 'delete') {
    deleteCar(idCar!);
    const garagePage = document.querySelector('[data-garage=garage]');
