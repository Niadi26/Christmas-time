...
class Footer {
  ...
  constructor() {
    const footer = new DomElement('footer', 'footer', '');
    const wrapper = new DomElement('div', 'footer__wrapper', '', '', footer.node);
    const school = new DomElement('a', 'navigation__item', 'Rs-school', '', wrapper.node);
    const year = new DomElement('a', '', '2022', '', wrapper.node);
    const git = new DomElement('a', 'navigation__item', 'gitHub', '', wrapper.node);
